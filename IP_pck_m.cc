...
const char * IP_pck::getSource_ip() const
{
    return this->source_ip.c_str();
}

void IP_pck::setSource_ip(const char * source_ip)
{
    this->source_ip = source_ip;
}

const char * IP_pck::getDest_ip() const
{
    return this->dest_ip.c_str();
}

void IP_pck::setDest_ip(const char * dest_ip)
{
...
int IP_pckDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "source_ip")==0) return base+0;
    if (fieldName[0]=='d' && strcmp(fieldName, "dest_ip")==0) return base+1;
...
std::string IP_pckDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    IP_pck *pp = (IP_pck *)object; (void)pp;
    switch (field) {
        case 0: return oppstring2string(pp->getSource_ip());
        case 1: return oppstring2string(pp->getDest_ip());
        default: return "";
    }
}
...
bool IP_pckDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    IP_pck *pp = (IP_pck *)object; (void)pp;
    switch (field) {
        case 0: pp->setSource_ip((value)); return true;
        case 1: pp->setDest_ip((value)); return true;
