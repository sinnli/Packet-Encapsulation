...
const char * Eth_pck::getSource_mac() const
{
    return this->source_mac.c_str();
}

void Eth_pck::setSource_mac(const char * source_mac)
{
    this->source_mac = source_mac;
}

const char * Eth_pck::getDest_mac() const
{
    return this->dest_mac.c_str();
}

void Eth_pck::setDest_mac(const char * dest_mac)
{
    this->dest_mac = dest_mac;
}

int Eth_pck::getTTL() const
{
    return this->TTL;
}

void Eth_pck::setTTL(int TTL)
{
    this->TTL = TTL;
}

short Eth_pck::getEthertype() const
{
    return this->Ethertype;
}

void Eth_pck::setEthertype(short Ethertype)
{
...
int Eth_pckDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "source_mac")==0) return base+0;
    if (fieldName[0]=='d' && strcmp(fieldName, "dest_mac")==0) return base+1;
...
std::string Eth_pckDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Eth_pck *pp = (Eth_pck *)object; (void)pp;
    switch (field) {
        case 0: return oppstring2string(pp->getSource_mac());
        case 1: return oppstring2string(pp->getDest_mac());
...
bool Eth_pckDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Eth_pck *pp = (Eth_pck *)object; (void)pp;
    switch (field) {
        case 0: pp->setSource_mac((value)); return true;
        case 1: pp->setDest_mac((value)); return true;
